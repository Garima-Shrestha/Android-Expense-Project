 ...
 * Use the [ExpenseCalculatorFragment.newInstance] factory method to
...
class ExpenseCalculatorFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ExpenseCalculatorFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ExpenseCalculatorFragment().apply {
